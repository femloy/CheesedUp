...
draw_sprite(spr_lang_left, 0, (SCREEN_WIDTH / 2) - 180 - left_offset, SCREEN_HEIGHT / 2);
draw_sprite(spr_lang_right, 0, (SCREEN_WIDTH / 2) + 180 + right_offset, SCREEN_HEIGHT / 2);
