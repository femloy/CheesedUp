...
if state != states.normal
	exit;
if other.state == states.hurt or other.state == states.gotoplayer or other.state == states.stringfall
or other.state == states.stringjump or other.state == states.stringfling
	exit;
