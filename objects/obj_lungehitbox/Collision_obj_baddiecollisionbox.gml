...
if !(_baddieID.state != states.grabbed && _baddieID.object_index != obj_pizzaball && !_baddieID.invincible && _baddieID.hittable && _baddieID.state != states.ghostpossess && other.baddieID.invtime <= 0)
	exit;

if check_boss(_baddieID.object_index)
{
	with _baddieID
	{
