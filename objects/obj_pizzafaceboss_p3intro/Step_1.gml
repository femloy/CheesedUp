...
switch introstate
{
	...
	case 2:
		...
		else if (floor(image_index) >= 2 && sprite_index != obj_player1.spr_gnomecutscene1)
		{
			with obj_player1
			{
				if sprite_index != spr_gnomecutscene2 && character != "N"
				{
					sprite_index = spr_gnomecutscene2;
					image_index = 0;
				}
				else if (character != "N" && floor(image_index) == image_number - 1)
					image_index = image_number - 1;
			}
		}
	...
	case 3:
		with obj_player1
		{
			if (character != "N" && floor(image_index) == image_number - 1)
				image_index = image_number - 1;
		}
		hsp = 7;
	...
	case 4:
		with obj_player1
		{
			if (character != "N" && floor(image_index) == image_number - 1) && sprite_index != spr_gnomecutscene1
				image_index = image_number - 1;
		}
		if (floor(image_index) == image_number - 1)
		{
	...
	case 9:
		...
		if ((obj_player1.image_index >= 20 || obj_player1.character == "N") && !shot)
		{
			if obj_player1.character != "N"
