...
function scr_characterspr(character = undefined)
{
	...
	spr_knightpepwalk = spr_cotton_run;
	spr_knightpepjump = spr_cotton_jump;
	spr_knightpepfall = spr_cotton_fall;
	spr_knightpepidle = spr_cotton_idle;
	spr_knightpepjumpstart = spr_cotton_land;
	...
	if character == "N"
	{
		...
		spr_knightpepwalk = spr_cotton_walk
		spr_knightpepjump = spr_cotton_jump
		spr_knightpepfall = spr_cotton_fall
		spr_knightpepidle = spr_cotton_idle
		spr_knightpepjumpstart = spr_playerN_bump
		spr_knightpepthunder = spr_cottonmaker
		spr_knightpepland = spr_cotton_land
		spr_knightpepdownslope = spr_cotton_roll
		spr_knightpepstart = spr_cottonpoof
		spr_knightpepcharge = spr_cotton_rollMax
		spr_knightpepfly = spr_cotton_doublejump
		spr_knightpepdoublejump = spr_cotton_doublefall
		spr_knightpepdowntrust = spr_cotton_drill
		spr_knightpepupslope = spr_cotton_roll
		spr_knightpepbump = spr_cotton_slam
