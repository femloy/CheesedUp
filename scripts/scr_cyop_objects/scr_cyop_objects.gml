...
global.cyop_objectlist = [
	...
	obj_ratfairy,
	obj_pumpkindoor,
	obj_null, //"obj_varstorage",
	"obj_skateboardOLD",
	obj_afom_lap2block,
	obj_afom_reverselap2block,
	obj_afom_lap3block,
	obj_afom_reverselap3block,
	obj_afom_lap4block,
	obj_afom_reverselap4block,
	"obj_ipgrabber (HILARIOUS!)", // thanks emerald shithead
	"obj_ipgrabbernoise (HILARIOUS!)",
	"obj_iptext (HILARIOUS!)",
	"obj_camera_scrollstop",
	obj_tornadoeffect,
	obj_noisedebris,
	obj_noiseeffect,
	obj_reversegeromeblock,
];

#endregion
#region NEW AFOM

global.afom_objectlist = [
	obj_noisecredit,
	obj_doisedead,
	obj_hardmode,
	obj_bosskeynoise,
	...
	obj_fakepepsolid,
	obj_farmer3projectile,
	obj_swapgusfightball,
	obj_pizzahead_finalecutsceneN,
	obj_gustavoswitch,
	obj_soundtest_next,
	obj_speedlinesup,
	obj_tutorialblock,
	...
	obj_smallforestblock,
	obj_fallingplatform,
	obj_bucketdestination,
	obj_costumedpizzahead,
	obj_hattreasure,
	obj_ghostcollectibles,
	obj_achievement_enemiesdead,
	obj_eggplantdisclaimer,
	...
	"obj_pizzafaceOLD",
	"obj_bigcheeseOLD",
	obj_afom_secretroomtrigger,
	"obj_noise_normalT1",
	"obj_collectarena", // handled manually
	"obj_bigcollectarena", // handled manually
	"obj_pizzasona_spawn", // handled manually
	"obj_skateboardOLD",
	"obj_iceblockOLD",
	"obj_hook",
	"obj_hookend",
	...
	"obj_createobject",
	"obj_spikeOLD",
	obj_afom_ballslope, // obj_ballslopeOLD
	obj_afom_darkcontroller,
	"obj_delay",
	"obj_getvar",
	"obj_variable",
	"obj_swimmablewater",
...
global.afom_objectmap = ds_map_create();
ds_map_set(global.afom_objectmap, "obj_varstorage", obj_null);
ds_map_set(global.afom_objectmap, "obj_lap2block", obj_afom_lap2block);
ds_map_set(global.afom_objectmap, "obj_reverselap2block", obj_afom_reverselap2block);
ds_map_set(global.afom_objectmap, "obj_lap3block", obj_afom_lap3block);
ds_map_set(global.afom_objectmap, "obj_reverselap3block", obj_afom_reverselap3block);
ds_map_set(global.afom_objectmap, "obj_lap4block", obj_afom_lap4block);
ds_map_set(global.afom_objectmap, "obj_reverselap4block", obj_afom_reverselap4block);
...
ds_map_set(global.afom_objectmap, "object189", obj_null);
